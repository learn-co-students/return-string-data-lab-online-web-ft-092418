...
10.times do
  products = ["tv", "vcr", "macbook", "macbook air", "mouse", "chair", "desk", "lamp", "water bottle"]
  Product.create(:name => products.sample, :price => Faker::Number.between(1,1500), :description => Faker::BojackHorseman.tongue_twister, :inventory => Faker::Number.between(5, 200))
end
5.times do
